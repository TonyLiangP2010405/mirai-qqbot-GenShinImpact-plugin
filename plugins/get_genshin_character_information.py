...
def genshin_character_all(bot: miraicle.Mirai, msg: miraicle.GroupMessage):
    if Path('character.json').exists():
        ...
        if msg.text in character_json:
            if not Path(character_json[msg.text]).exists():
                get_character_detail(character_json[msg.text])
            message = solve_character_detail_json(character_json[msg.text])
            send_message = []
            ...
            # 画廊
            message2 = solve_character_content_picture(character_json[msg.text])
            ...
            message3 = solve_character_content_talent(character_json[msg.text])
            ...
            # 命之座
            message4 = solve_character_content_mingzhizuo(character_json[msg.text])
            ...
            # 故事
            message5 = solve_character_content_story(character_json[msg.text])
            ...
            # 语音
            message6 = solve_character_content_voice(character_json[msg.text])
